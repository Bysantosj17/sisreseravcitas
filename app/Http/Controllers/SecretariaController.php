...
class SecretariaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            'nombres' => 'required',
            'apellidos' => 'required',
            'ine' => 'required|unique:secretarias',
            'celular' => 'required',
    ...
    {
        $secretaria = Secretaria::with('user')->findOrFail($edit);
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'nombres' => 'required',
            'apellidos' => 'required',
            'ine' => 'required|unique:secretarias,ine,'.$secretaria->id,
            'celular' => 'required',
            'fecha_nacimiento' => 'required',
            'direccion' => 'required',
    ...
    public function confirmDelte($id)
    {
        $secretaria = Secretaria::with('user')->findOrFail($id);
